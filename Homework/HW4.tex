...
{\bf Homework \# 4} \hfill {\bf due: 11:59PM, {\color{blue} December 21st}, 2025}
...
\item {\color{blue} Show that the protocol above is perfectly hiding. }
\end{enumerate}
{\color{blue}To show that the protocol is binding, we first introduce a version of the protocol where at the first step Bob sends half-EPR pairs to Alice.} 
\begin{enumerate}
