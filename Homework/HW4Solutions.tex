...
\begin{enumerate}
  ...
  \tag{By properties of $\mathcal{F}$}\\
	...
	Note that on the one hand, for $\Id\otimes \rho_{E}$, the probability that given the quantum state in $E$, an adversary can guess the first register with probability exactly $\frac{1}{2}$.
