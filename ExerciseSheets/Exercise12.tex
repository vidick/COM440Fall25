...
Note that here, we only allow $\mathcal{A}$ to make classical queries to the tagging oracle for simplicity. 
\begin{enumerate}
...
\item Show that the scheme is $\eps$-binding, for some $\eps$ depending on $m$ to be determined. 
\end{enumerate}
