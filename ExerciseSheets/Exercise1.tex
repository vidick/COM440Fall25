...
%\solopen{This is similar to the previous question. When Alice gets sent the $\ket{+}$ state, she will perfectly detect this in the [$ \{\ket{+},\ket{-}\}$  basis. When Alice gets sent the $\ket{0}$ state, the outcome of a measurement in the $\{\ket{+},\ket{-}\}$ basis will give her 0 or 1 with probability a half.}
% \begin{enumerate}[a)]
% 	\item $p=1,q=0$
% 	\item $p=\frac{1}{2},q=0$
% 	\item $p=1,q=\frac{1}{2}$
